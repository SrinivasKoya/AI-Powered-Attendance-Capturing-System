...
def main():
    bucket = 'studentss'  #Your Bucket Name 
    collection_id='attendance10'  #Your Collection Name you created in the last step   
    ...
    photos = ["Ganguly.jpg","kapildev.jpg","sehwag.jpg"]
