...
faceCascade = cv2.CascadeClassifier(r'C:\Users\Hp\Codes\haarcascade_frontalface_default.xml') # xml file to detect the faces 
...
def uploadimage():
    ...
    bucket = 'studentss' # Replace with your bucket name
